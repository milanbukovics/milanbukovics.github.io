...
<div class="text-center p-4">
  <img width="450px" src="../img/SensorBoard.png" class="img-thumbnail">
</div>
...
If you'd like, I can also make a **horizontal banner**, **system diagram**, or a **clean single-page PDF version**.
